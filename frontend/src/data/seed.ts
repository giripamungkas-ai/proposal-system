...
async function main() {
  ...
  const salesManagerUser = createdUsers.find(
    (u) => u.role === "SALES_MANAGER",
  )!;
  ...
  const approvals = [
    ...
    },
    {
      ...
      decision: "approved",
      comment:
        "Proposal meets all requirements. Approved for final submission.",
  ...
  const issues = [
    ...
    },
    {
      ...
      description:
        "Client has concerns about SMS delivery rates to certain operators.",
      severity: "low",
      status: "resolved",
